...
VALUES ("ulmI","xo{mQ","2000-03-28","0469/23.12.56","M",false,"tmXomwJ",null,"Informatique"),
("~plviS","lwxp[","2002-10-15","0470/78.35.82","M",true,null,null,"Informatique"),
("v|}],lV)mK","qys{iT","2001-05-21","0471/13.82.45","F",true,"qyknkV",1,"Marin"),
("ypz*wi]","~kl}S","2000-02-13","0469/77.53.09","M",true,"{^tM",null,"Mécanique"),
("o|wY","kwvH","1997-05-20","0470/153.759","M",false,null,null,"Chimiste"),
("qplviK","~ou}Q","1999-01-08","0471/978.312","M",true,"tztmP*np[",2,"Ninja");
